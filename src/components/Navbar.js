...
import { GithubIcon, LinkedInIcon, MoonIcon, StackOverflowIcon, SunIcon, UpworkIcon } from './Icons';
  ...
  return (
    <header className=" w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8">
      ...
      <button className='flex-col justify-center items-center hidden lg:flex' onClick={handleClick}>
        <span className={`bg-dark dark:bg-light block transition-all duration ease-out h-0.5 w-6 rounded-sm  ${isOpen ? 'rotate-45 translate-y-1' : '-translate-y-0.5' } `}></span>
        <span className={`bg-dark dark:bg-light block transition-all duration ease-out h-0.5 w-6 rounded-sm my-0.5 ${isOpen ? 'opacity-0' : 'opacity-100' }`}></span>
        <span className={`bg-dark dark:bg-light block transition-all duration ease-out h-0.5 w-6 rounded-sm  ${isOpen ? '-rotate-45 -translate-y-1' : ' translate-y-0.5' } `}></span>
      </button> 
      ...
      <div className='w-full flex justify-between items-center lg:hidden'>
        ...
        <nav className='flex items-center justify-center flex-wrap'>
          <motion.a href="https://github.com/cjpanda" 
            target={"_blank"} 
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}
            className='w-6 mx-3'
          ...
          <motion.a href="https://stackoverflow.com/users/19345782/cjpanda" 
            target={"_blank"}
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}
            className='w-6 mx-3'
          ...
          <motion.a href="https://www.linkedin.com/in/benedict-umenzekwe-38b2a2235/" 
            target={"_blank"}
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}
            className='w-6 mx-3'
          ...
          <motion.a href="https://www.upwork.com/freelancers/~01e41ddf64a31fda51" 
            target={"_blank"}
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}
            className='w-6 ml-3'
